...
Messages.quit = "Haluatko varmasti lopettaa?"
Messages.username_prompt = "käyttäjätunnus"
Messages.enter_password = "syötä salasana"
Messages.enter_import_password = "syötä import-salasana"
Messages.incorrect_password = "väärä salasana"
Messages.repeat_password = "toista salasana"
Messages.passwords_differ = "salasanat eroavat toisistaan"
Messages.installation_finished = "Asennus onnistui"
Messages.cat_dir_exisits = "Hakemisto {} on jo olemassa; sen sisältö " \
    "mahdollisesti ylikirjoitetaan."
Messages.cont = "Haluatko jatkaa?"
Messages.nm_not_supported = "Tämä NetworkManagerin versio ei ole " \
    "tuettu."
Messages.cert_error = "Varmennetiedostoa ei löytynyt"
Messages.unknown_version = "Tuntematon versio"
Messages.dbus_error = "DBus-yhteysongelma, sudo-komento saattaa " \
    "auttaa"
Messages.yes = "K"
Messages.no = "E"
Messages.p12_filter = "henkilövarmennetiedosto (p12 tai pfx)"
Messages.all_filter = "Kaikki tiedostot"
Messages.p12_title = "henkilövarmennetiedosto (p12 tai pfx)"
Messages.save_wpa_conf = "NetworkManagerin asetuksia ei voitu " \
    "määritellä, mutta voimme luoda wpa_supplicant-määritystiedoston, " \
    "jos haluat. Muista, että salasanasi tallennetaan tähän tiedostoon " \
    "selkokielisessä muodossa."
Messages.save_wpa_confirm = "Luo tiedosto"
Messages.wrongUsernameFormat = "Virhe: Käyttäjätunnuksen muoto " \
    "pitää olla 'xxx@institutionID', esimerkiksi 'tunnus@yliopisto.fi'!"
Messages.wrong_realm = "Virhe: Käyttäjätunnuksen pitää olla " \
    "muodossa 'xxx@{}'. Yritä uudelleen."
Messages.wrong_realm_suffix = "Virhe: Käyttäjätunnuksen pitää " \
    "olla muodossa 'xxx@institutionID', ja päättyä '{}'. Annathan " \
    "tunnuksen oikeassa muodossa."
Messages.user_cert_missing = "henkilövarmennetiedostoa ei löytynyt"
Config.instname = "Itä-Suomen yliopisto"
Config.profilename = "UEF eduroam"
Config.url = "paikallinen eduroam®-tukisivu"
Config.email = "paikallinen eduroam®-tuki"
Config.title = "eduroam CAT"
Config.server_match = "uef.fi"
Config.eap_outer = "PEAP"
Config.eap_inner = "MSCHAPV2"
Config.init_info = "Tämä asennustiedosto on valmisteltu " \
    "organisaatiolle {0}\n\nLisätietoa ja kommentit:\n\nEMAIL: {1}\nWWW: " \
    "{2}\n\nAsennusohjelma on tehty GEANT-projektissa. "
Config.init_confirmation = "Tämä asennustiedosto toimii ainoastaan " \
    "organisaation {0} käyttäjillä."
Config.ssids = ['eduroam', 'uef-student']
Config.del_ssids = []
Config.servers = ['DNS:wlan-radius1.uef.fi', 'DNS:wlan-radius2.uef.fi']
